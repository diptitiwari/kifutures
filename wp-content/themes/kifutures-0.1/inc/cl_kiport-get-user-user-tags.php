...
$data = kifutures_kp_um_api_get_user_user_tags();
//print_r($data);
//exit;

if(empty($data)) return false;

$dt = current_time('mysql', 1); // date & time stamp for inserted/updated records
...
foreach($data as $user_user_tag) {
  $rows_affected = kifutures_kp_um_api_insert_user_user_tag( $user_user_tag, $dt );
